...
const Websites = () => {
    ...
    const education = [
      {
        ...
        description: "Master of Science in Computer Science, 2022 - 2024",
    ...
    return (
        <div id="experience" className="mt-4 max-w-7xl mx-auto flex flex-col items-center justify-center">
            <div className={`${styles.paddingX} w-full flex flex-col items-start justify-between`}>
                <p className={`${styles.sectionSubText} ${isLight ? "text-black-200" : "text-white-100" } mt-10 font-semibold`}>My</p>
                <h2 className={`${styles.sectionHeadText} ${isLight ? "text-black-100" : "text-white-100"} mb-16`}>Experience and Education</h2>
          ...
          >
            ...
            <iframe src={experience[active].link} className={`my-10 md:hidden w-screen h-[600px] border-2 ${isLight ? "border-black" : "border-white"} rounded-xl mb-5 landscape:hidden`} >Sorry Error!!</iframe>
