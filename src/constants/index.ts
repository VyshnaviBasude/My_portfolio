import { backend, binaryTrees, cp, docker, uber,Azure_Migration,CICD, frontend,sf, kafka, object, linkedList, redis,admin,pd,iot,pydata } from '../assets';
...
export const achievements = [
    {title: "Certified Salesforce Administrator", icon: admin,link: "https://www.salesforce.com/trailblazer/profile"}, 
